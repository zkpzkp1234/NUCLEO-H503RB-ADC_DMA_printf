...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  if(finished)
	  {
		  uhADCxConvertedData_Voltage_mVolt = __LL_ADC_CALC_DATA_TO_VOLTAGE(VDDA_APPLI, adc_buf[ADC_BUF_LEN-1], LL_ADC_RESOLUTION_12B);
